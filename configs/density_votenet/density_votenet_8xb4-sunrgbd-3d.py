...
train_dataloader = dict(
    batch_size=20, dataset=dict(dataset=dict(data_root='data2/sunrgbd/')))

# Validation dataloader
val_dataloader = dict(batch_size=20, dataset=dict(data_root='data2/sunrgbd/'))

# Test dataloader
test_dataloader = dict(batch_size=20, dataset=dict(data_root='data2/sunrgbd/'))
