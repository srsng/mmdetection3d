...
val_dataloader = dict(batch_size=20, dataset=dict(data_root="data2/mini_sunrgbd/"))

# Test dataloader
test_dataloader = dict(batch_size=20, dataset=dict(data_root="data2/mini_sunrgbd/"))
