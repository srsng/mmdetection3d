...
**数据存放路径**: `./data2/mini_sunrgbd/`

**MMDetection3D 配置路径**: `./configs/`
...
| 用途         | 文件路径                                            |
| ------------ | --------------------------------------------------- |
| 训练集 pkl   | `./data2/mini_sunrgbd/mini_sunrgbd_infos_train.pkl` |
| 验证集 pkl   | `./data2/mini_sunrgbd/mini_sunrgbd_infos_val.pkl`   |
| 数据集类     | `./mmdet3d/datasets/mini_sunrgbd_dataset.py`        |
| 数据集配置   | `./configs/_base_/datasets/mini_sunrgbd_3d.py`      |
| 模型配置     | `./configs/votenet_mini_sunrgbd.py`                 |
| 数据转换脚本 | `./data2/mini_sunrgbd/mini_sunrgbd_converter.py`    |
...
数据转换脚本位于 `./data2/mini_sunrgbd/mini_sunrgbd_converter.py`，功能包括：
